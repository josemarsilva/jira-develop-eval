...
* [Project](#4-Project)
  * [Guide for Users, Developers and Administrators](#41-guide-for-users-developers-and-administrators)
    ...
    * [Run a HelloWorld in Script Console from ScriptRunner](#418-groovy-script-run-a-helloworld-in-script-console-from-scriptrunner)
    ...
    * [Setup Atlassian SDK enviroment to Adaptavist ScriptRunner](#4112-setup-atlassian-sdk-enviroment-to-adaptavist-scriptrunner)
    * [Install User Custom Plugin package generated by Atlassian SDK into Jira](#4113-install-user-custom-plugin-package-generated-by-atlassian-sdk-into-jira)
...
* *Step-by-step*: [Instaling Jira Workflow Toolbox (JWT)](./doc/install-jira-workflow-toolbox-server-step-by-step.md)
...
* *Step-by-step*: [Install User Custom Plugin package generated by Atlassian SDK into Jira](./doc/install-user-custom-plugin-package-generated-by-atlassian-sdk-into-jira.md)
...
* *Step-by-step*: [Groovy script debug with Apache Log4J](./doc/example-groovy-script-console-with-apache-log4j.md)
...
* *Features*: 
  ...
  * Customizar a aplicação para implementar 2 métodos: `String getName()` e `HashMap<String,String> getHashMap()`

* *Step-by-step*: [Install User Custom Plugin package generated by Atlassian SDK into Jira](./doc/modify-user-custom-plugin-using-atlassian-sdk-with-multiples-methods.md)
