/**
 * RetrieveRequestForChangePadraoResponse.java
 *
...
public class RetrieveRequestForChangePadraoResponse  implements java.io.Serializable {
    private com.peregrine.servicecenter.PWS.RequestForChangePadraoModelType model;
    ...
    public RetrieveRequestForChangePadraoResponse() {
    }

    public RetrieveRequestForChangePadraoResponse(
           com.peregrine.servicecenter.PWS.RequestForChangePadraoModelType model,
    ...
    /**
     * Gets the model value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return model
     */
    public com.peregrine.servicecenter.PWS.RequestForChangePadraoModelType getModel() {
        return model;
    }


    /**
     * Sets the model value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param model
     */
    public void setModel(com.peregrine.servicecenter.PWS.RequestForChangePadraoModelType model) {
        this.model = model;
    }


    /**
     * Gets the messages value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveRequestForChangePadraoResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveRequestForChangePadraoResponse)) return false;
        RetrieveRequestForChangePadraoResponse other = (RetrieveRequestForChangePadraoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveRequestForChangePadraoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", ">RetrieveRequestForChangePadraoResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", "RequestForChangePadraoModelType"));
