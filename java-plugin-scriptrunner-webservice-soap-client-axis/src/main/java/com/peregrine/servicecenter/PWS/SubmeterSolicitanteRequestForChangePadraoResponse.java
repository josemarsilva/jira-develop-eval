/**
 * SubmeterSolicitanteRequestForChangePadraoResponse.java
 *
...
public class SubmeterSolicitanteRequestForChangePadraoResponse  implements java.io.Serializable {
    ...
    public SubmeterSolicitanteRequestForChangePadraoResponse() {
    }
    ...
    /**
     * Gets the model value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @return model
     */
    ...
    /**
     * Sets the model value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @param model
     */
    ...
    /**
     * Gets the messages value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this SubmeterSolicitanteRequestForChangePadraoResponse.
     * 
     * @param query
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubmeterSolicitanteRequestForChangePadraoResponse)) return false;
        SubmeterSolicitanteRequestForChangePadraoResponse other = (SubmeterSolicitanteRequestForChangePadraoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubmeterSolicitanteRequestForChangePadraoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", ">SubmeterSolicitanteRequestForChangePadraoResponse"));
