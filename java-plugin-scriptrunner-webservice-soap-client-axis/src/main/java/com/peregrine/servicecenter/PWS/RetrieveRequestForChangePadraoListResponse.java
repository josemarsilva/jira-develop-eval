/**
 * RetrieveRequestForChangePadraoListResponse.java
 *
...
public class RetrieveRequestForChangePadraoListResponse  implements java.io.Serializable {
    ...
    public RetrieveRequestForChangePadraoListResponse() {
    }
    ...
    /**
     * Gets the instance value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return instance
     */
    ...
    /**
     * Sets the instance value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param instance
     */
    ...
    public com.peregrine.servicecenter.PWS.RequestForChangePadraoInstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.peregrine.servicecenter.PWS.RequestForChangePadraoInstanceType _value) {
        this.instance[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveRequestForChangePadraoListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveRequestForChangePadraoListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveRequestForChangePadraoListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveRequestForChangePadraoListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveRequestForChangePadraoListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveRequestForChangePadraoListResponse)) return false;
        RetrieveRequestForChangePadraoListResponse other = (RetrieveRequestForChangePadraoListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveRequestForChangePadraoListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", ">RetrieveRequestForChangePadraoListResponse"));
