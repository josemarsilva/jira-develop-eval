/**
 * RetrieveRequestForChangePadraoKeysListResponse.java
 *
...
public class RetrieveRequestForChangePadraoKeysListResponse  implements java.io.Serializable {
    ...
    public RetrieveRequestForChangePadraoKeysListResponse() {
    }
    ...
    /**
     * Gets the keys value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return keys
     */
    ...
    /**
     * Sets the keys value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param keys
     */
    ...
    public com.peregrine.servicecenter.PWS.RequestForChangePadraoKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.peregrine.servicecenter.PWS.RequestForChangePadraoKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveRequestForChangePadraoKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveRequestForChangePadraoKeysListResponse)) return false;
        RetrieveRequestForChangePadraoKeysListResponse other = (RetrieveRequestForChangePadraoKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveRequestForChangePadraoKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", ">RetrieveRequestForChangePadraoKeysListResponse"));
