/**
 * SubmeterSolicitanteRequestForChangePadraoRequest.java
 *
...
public class SubmeterSolicitanteRequestForChangePadraoRequest  implements java.io.Serializable {
    ...
    public SubmeterSolicitanteRequestForChangePadraoRequest() {
    }
    ...
    /**
     * Gets the model value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
     * @return model
     */
    ...
    /**
     * Sets the model value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
     * @param model
     */
    ...
    /**
     * Gets the attachmentInfo value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Sets the attachmentInfo value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Gets the attachmentData value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Sets the attachmentData value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Gets the ignoreEmptyElements value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Sets the ignoreEmptyElements value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Gets the updateconstraint value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    /**
     * Sets the updateconstraint value for this SubmeterSolicitanteRequestForChangePadraoRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubmeterSolicitanteRequestForChangePadraoRequest)) return false;
        SubmeterSolicitanteRequestForChangePadraoRequest other = (SubmeterSolicitanteRequestForChangePadraoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubmeterSolicitanteRequestForChangePadraoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", ">SubmeterSolicitanteRequestForChangePadraoRequest"));
