/**
 * SubmeterGmudRequestForChangePadraoResponse.java
 *
...
public class SubmeterGmudRequestForChangePadraoResponse  implements java.io.Serializable {
    ...
    public SubmeterGmudRequestForChangePadraoResponse() {
    }
    ...
    /**
     * Gets the model value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @return model
     */
    ...
    /**
     * Sets the model value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @param model
     */
    ...
    /**
     * Gets the messages value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this SubmeterGmudRequestForChangePadraoResponse.
     * 
     * @param query
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubmeterGmudRequestForChangePadraoResponse)) return false;
        SubmeterGmudRequestForChangePadraoResponse other = (SubmeterGmudRequestForChangePadraoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubmeterGmudRequestForChangePadraoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicecenter.peregrine.com/PWS", ">SubmeterGmudRequestForChangePadraoResponse"));
